# TODO: Ajustar Goals para incluir Currency

## Tarefas
- [x] Adicionar campo currency ao modelo Goal.js
- [x] Atualizar validação em validation.js para incluir currency, priority, category
